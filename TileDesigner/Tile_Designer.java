...
public class Tile_Designer extends JFrame
{
    ...
    final private static String[] imagename = { "pat1.gif", "pat2.gif", "pat3.gif", "pat4.gif" };
    ...
    private static Tile_Canvas canvas;//JPanel that paints the tile design grid
    ...
    ********************************************************************/
    ...
    {
        //create canvas panel
        canvas = new Tile_Canvas();

        //add tool bar to top of frame
        getContentPane().add(createTileBar(), BorderLayout.NORTH);

        //add canvas to center of frame
	    getContentPane().add(canvas, BorderLayout.CENTER);

        //add reset button to bottom of frame
        getContentPane().add(createResetButton(), BorderLayout.SOUTH);
