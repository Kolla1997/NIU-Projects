...
class BioinformaticsProject2a {
  ...
  public static void countReturns(String x, String y) {
    ...
    String bases = "ACGT";
    System.out.println("Pair Counts\tA \tC \tG \tT");
    for (int k = 0; k < 4; k++) {
        ...
        if (l.length() > 0) {
          ...
          if (character == 's') {
            ...
            if (no_gens == 2) {
              ...
              countReturns(genes[0].substring(265, 13467), genes[1].substring(265, 13467));
              System.out.println("GAP RATE");
              gapCountReturns(genes[0].substring(265, 13467), genes[1].substring(265, 13467));

              System.out.println("\n" + "orf1b" + "\n");
              System.out.println("Substitution Rate");
              countReturns(genes[0].substring(13467, 21554), genes[1].substring(13467, 21554));
              System.out.println("GAP RATE");
              gapCountReturns(genes[0].substring(13467, 21554), genes[1].substring(13467, 21554));

              System.out.println("\n" + "S" + "\n");
              System.out.println("Substitution Rate");
              countReturns(genes[0].substring(21562, 25383), genes[1].substring(21562, 25383));
              System.out.println("GAP RATE");
              gapCountReturns(genes[0].substring(21562, 25383), genes[1].substring(21562, 25383));

              System.out.println("\n" + "E" + "\n");
              System.out.println("Substitution Rate");
              countReturns(genes[0].substring(26244, 26471), genes[1].substring(26244, 26471));
              System.out.println("GAP RATE");
              gapCountReturns(genes[0].substring(26244, 26471), genes[1].substring(26244, 26471));

              System.out.println("\n" + "M" + "\n");
              System.out.println("Substitution Rate");
              countReturns(genes[0].substring(26522, 27190), genes[1].substring(26522, 27190));
              System.out.println("GAP RATE");
              gapCountReturns(genes[0].substring(26522, 27190), genes[1].substring(26522, 27190));

              System.out.println("\n" + "N" + "\n");
              System.out.println("Substitution Rate");
              countReturns(genes[0].substring(28273, 29532), genes[1].substring(28273, 29532));
              System.out.println("GAP RATE");
